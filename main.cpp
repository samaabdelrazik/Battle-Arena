...
//Block random function
    ...
    QObject::connect(time, &QTimer::timeout, [time, scene](){
        ...
        int y = QRandomGenerator::global()->bounded(50, 610);
        block->setPos(x,y);
...
// End of text on the right side of the screen
